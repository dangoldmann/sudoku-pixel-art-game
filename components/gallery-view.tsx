...
export function GalleryView({ completedLevels, isStorageLoaded, onBack }: GalleryViewProps) {
  ...
  return (
    <div className="bg-background min-h-screen p-3 sm:p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        {/* Empty state */}
        {isStorageLoaded && completedLevels.length === 0 && (
        ...
        {/* Locked artworks */}
        {isStorageLoaded && levels.length > completedLevels.length && (
          <div className="space-y-4">
